          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-lg border border-[hsl(214,32%,91%)] bg-transparent py-2.5 px-4 text-sm text-[hsl(222,47%,11%)] outline-none focus:border-[hsl(var(--primary))] focus:ring-1 focus:ring-[hsl(var(--primary))] dark:border-[hsl(217,33%,17%)] dark:text-white"
              >
